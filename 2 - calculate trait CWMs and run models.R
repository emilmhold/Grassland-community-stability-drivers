...
write_rds(fdiv, "output/July 2021 FD.rds")
...
CWM.productivity.lmm <- lmer(Productivity ~ Max.Height*SLA*RTD + (1|Block), data = gain.loss)
summary(CWM.productivity.lmm)
Anova(CWM.productivity.lmm)
qqnorm(resid(CWM.productivity.lmm))
qqline(resid(CWM.productivity.lmm))
shapiro.test(resid(CWM.productivity.lmm))
